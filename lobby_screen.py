...
class Ui_readyWindow(object):
    ...
    def setupUi(self, readyWindow):
        ...
        self.voice_button.setGeometry(QtCore.QRect(10, 480, 251, 61))
        ...
        self.leaderboard_button.setGeometry(QtCore.QRect(10, 390, 251, 71))
        ...
        self.tutorial_button.setGeometry(QtCore.QRect(500, 480, 251, 61))
        ...
        self.instructions_button.setGeometry(QtCore.QRect(500, 390, 251, 71))
        self.instructions_button.setStyleSheet(";background-color: rgb(255, 0, 0);\n"
                                           "font: 75 8pt \"Magneto\"; font-size: 35px;height: 20px;width: 45px;")
    ...
    def retranslateUi(self, readyWindow):
        ...
        self.instructions_button.setText(_translate("readyWindow", "instructions"))
    ...
    def check_for_button(self, MainWindow):
        ...
        self.instructions_button.clicked.connect(self.instructions_pressed)

    def instructions_pressed(self):
        self.voice_button.hide()
        self.leaderboard_button.hide()
        self.tutorial_button.hide()
        self.instructions_button.hide()
        self._mutex.lock()
        self.client.screen_state = 6
        self._mutex.unlock()
